...
class TranslatorViewController: UIViewController {
    ...
    @IBAction func showCall(_ sender: Any) {
    ...
    func downloadUser() {
        ...
        ref.observe(.value) { (snapshot) in
                ...
                let available = dict["available"] as? Bool
            {
                ...
                var user = User(name: name, image: nil, password: "", imageURL: URL(string: imageURL), surname: surname, email: email, phone: phone, location: location, gender: gender, age: age, isTranslator: isTranslator, languages:languages, available: available)
